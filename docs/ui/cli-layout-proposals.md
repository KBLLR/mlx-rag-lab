...
1. Extract shared UI helpers into `apps/ui/`
2. Apply chat layout to:
   - `chat_cli.py`
   - `rag_cli.py`
   - `voice_chat_cli.py`
3. Refactor batch apps to use unified progress/log layout
4. Implement file/tree panel for `sts_avatar_cli.py`
